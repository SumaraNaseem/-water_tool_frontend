...
export default function Oversvamning() {
    ...
    <div className="bg-white rounded-lg relative">
      ...
      {showNotification && (
        <div className={`fixed top-4 right-4 z-50 ${isAnimatingOut ? 'animate-slide-out' : 'animate-slide-in'}`}>
          <div className="bg-orange-500 text-white px-6 py-3 rounded-lg shadow-lg flex items-center gap-2 max-w-sm">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
            </svg>
            <span className="text-sm font-medium">Översvämningsanalys slutförd!</span>
          </div>
        </div>
      )}
      {/* Main Title */}
      ...
      <button 
        ...
        className="bg-[#ffb343] hover:bg-[#ffb343] text-white px-8 py-2 rounded-3xl font-semibold text-md transition-colors shadow-lg mb-6 mx-auto"
      >
        <i className="fas fa-calculator  mr-2"></i>
        Beräkna Översvämningsanalys
      </button>

      {/* Calculation Results Section */}
      <div className="bg-green-50 border-l-4 border-green-500 rounded-lg p-6 shadow-sm mb-6"> 
        <h3 className="text-xl font-bold text-gray-800 mb-4">Översvämningsanalys</h3>
        ...
        <div className="grid grid-cols-4 gap-4">
          <div className="bg-white border border-gray-200 rounded-lg p-4 text-center shadow-sm hover:-translate-y-1 transition-all duration-300 ">
            <h4 className="text-sm font-semibold text-gray-600 mb-2 uppercase">Översvämningsnivå</h4>
            <div className="text-3xl font-bold text-[#667eea]">0</div>
            <div className="text-sm text-gray-500">cm</div>
          </div>
          
          <div className="bg-white border border-gray-200 rounded-lg p-4 text-center shadow-sm hover:-translate-y-1 transition-all duration-300 ">
            <h4 className="text-sm font-semibold text-gray-600 mb-2 uppercase">Risknivå </h4>
            <div className="text-3xl font-bold text-[#667eea]">lag</div>
            <div className="text-sm text-gray-500">-</div>
          </div>
          
          <div className="bg-white border border-gray-200 rounded-lg p-4 text-center shadow-sm hover:-translate-y-1 transition-all duration-300 ">
            <h4 className="text-sm font-semibold text-gray-600 mb-2 uppercase">Ekonomisk skada</h4>
            <div className="text-3xl font-bold text-[#667eea]">0</div>
            <div className="text-sm text-gray-500">kkr</div>
          </div>
          
          <div className="bg-white border border-gray-200 rounded-lg p-4 text-center shadow-sm hover:-translate-y-1 transition-all duration-300 ">
            <h4 className="text-sm font-semibold text-gray-600 mb-2 uppercase">Påverkade byggnader</h4>
            <div className="text-3xl font-bold text-[#667eea]">0</div>
